    ...
    <div className="about">
      ...
      <div className="about-contents">
        <div className="about-content" {...animatedItem[3]}>
          ...
          <p>
            여러 가지 일들을 했었습니다. 저는 무언가를 만드는것을 좋아하고 어려운 문제를 푸는 것을 좋아하는 편입니다.
            그래서 사람들이 사용하고 추억을 가질 수 있는 물건을 만드는 일을 하고싶었습니다. 기존에 일들에서는 
            부족함을 느꼈습니다. 그러던 도중 프로그래밍을 접하게 되었고 좀 더 나와 맞는다고 생각하였습니다.
          </p>
          <p>
        ...
        <div className="about-content" {...animatedItem[4]}>
          ...
          이전부터 계속 관심이 있던 프로그래밍을 다양한 매체를 통해서 독학을 해보았습니다.
           ...
           시간이 오래 걸리고 풀지 못할 때도 있었지만, 코딩하면서 집중을 하고 문제를 풀고 기쁨을 느끼는 나 자신을
           보고 개발자를 하는 것에 대해 확신을 하게 되었습니다.
          </p>
          <p>
          이후, 
