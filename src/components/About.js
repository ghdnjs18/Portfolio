    ...
    <div className="about">
      ...
      <div className="about-contents">
        <div className="about-content" {...animatedItem[3]}>
          ...
          <p>
            저는 무언가를 만드는 것을 좋아하고 어려운 문제를 푸는 것을 좋아하는 편입니다.
            어릴 적부터 만들기와 조립 등을 취미로 하였습니다.
            그래서 사람들이 사용하고 추억을 가질 수 있는 물건을 만드는 일을 하고 싶었습니다. 
            기존에 일들을 하면서는 무언가 부족함을 느꼈고,
            그러던 도중 프로그래밍을 접하게 되었고 좀 더 저와 맞는다고 생각하였습니다.
          </p>
          <p>
        ...
        <div className="about-content" {...animatedItem[4]}>
          ...
          <p>
           ...
           시간이 오래 걸리고 풀지 못할 때도 있었지만, 코딩하면서 집중하고 문제를 풀고 기쁨을 느끼는 나 자신을
           보고 개발자를 하는 것에 대해 확신하게 되었습니다.
          </p>
          <p>
          이후, 
           ...
           프로젝트를 진행하면서 코딩 능력뿐만 아니라 기획과 진행 과정에서 팀원들과의 소통의 중요성을 배웠습니다.
          </p>
        </div>
